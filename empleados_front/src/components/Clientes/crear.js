        ...
        return (
            ...
            <Container id="clientes-crear-container" >
                ...
                <form class="formulario" action="#" method="POST">
                    <h2>
                        Procedimiento para agregar un registro de cliente a la base de datos.
                    </h2>
                    ...
                    <div class="enviar">
                            <input class="boton" type="submit" value="Crear" onClick={() => console.log(this.guardarClientes())} />
                    </div>
                </div>
                </form>
