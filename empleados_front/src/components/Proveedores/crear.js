    ...
    render() {
        return (
            ...
            <Container id="proveedores-crear-container" >
                ...
                <Row>
                <legend>Creación de proveedores</legend>


                </Row>
                <form class="formulario" action="#" method="POST">
                    <h2>
                        Procedimiento para agregar un registro de proveedor a la base de datos.
                    </h2>
                    ...
                    <div class="enviar">
                            <input class="boton" type="submit" value="Crear" onClick={() => console.log(this.guardarProveedores())} />
                    </div>
                </div>
                </form>
