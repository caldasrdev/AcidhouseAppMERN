...
export default class ProveedoresBuscar extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      confirmation: {
        ...
        text: ' ¿Desea eliminar un proveedor?',
        show: false,
      },
      message: {
        text: '',
  ...
  onClickEditButton(row) {
    ...
    this.props.setIdProveedor(row._id);
    ...
    eliminarProveedor() {
      ...
      request
        .delete(`/proveedor/${this.state.idProveedor}`)
        .then((response) => {
          this.setState({
            loading: false,
            message: {
    ...
    return (
      <Container id="proveedores-buscar-container">
        ...
        <Loading show={this.state.loading} />
          <Row>
          <h> Buscar proveedores </h>
          </Row>
          <Row>
          <Datagrid url='/proveedores'
            columns={columns}
            showEditButton={true}
